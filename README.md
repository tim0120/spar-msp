...
define a yaml config file (or use the provided `quant/scripts/train_mnist/mnist.yaml`) and run

```bash
python quant/scripts/train_mnist/run_train_mnist.py <path_to_config_file>
```
